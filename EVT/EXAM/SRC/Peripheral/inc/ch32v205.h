/********************************** (C) COPYRIGHT  *******************************
 * File Name          : ch32v205.h
 * Author             : WCH
 * Version            : V1.0.1
 * Date               : 2025/12/10
 * Description        : CH32V205 Device Peripheral Access Layer Header File.
 *********************************************************************************
...
#define HSE_STARTUP_TIMEOUT       ((uint16_t)0x6000) /* Time out for HSE start up */

#define HSI_VALUE                 ((uint32_t)8000000) /* Value of the Internal oscillator in Hz */

#define HSI_LP_VALUE              ((uint32_t)1000000) /* Value of the Internal oscillator in Hz for low power mode */

/* CH32V205 Standard Peripheral Library version number */
#define __CH32V205_STDPERIPH_VERSION_MAIN   (0x01) /* [15:8] main version */
#define __CH32V205_STDPERIPH_VERSION_SUB    (0x02) /* [7:0] sub version */
#define __CH32V205_STDPERIPH_VERSION        ( (__CH32V205_STDPERIPH_VERSION_MAIN << 8)\
                                             |(__CH32V205_STDPERIPH_VERSION_SUB << 0))
...
typedef enum IRQn
{
    ...
    PIOC_IRQn = 63,            /* PIOC global Interrupt                                */
    ...
    LVDS_IRQn = 70,            /* LVDS global Interrupt                                */
    USBHSWakeup_IRQn = 71,     /* USBHS WakeUp Interrupt                               */
    LVDSWakeup_IRQn = 72,      /* LVDS WakeUp Interrupt                                */
    USART5_IRQn = 73,          /* USART5 global Interrupt                              */
    USART6_IRQn = 74,          /* USART6 global Interrupt                              */    
    USART7_IRQn = 75,          /* USART7 global Interrupt                              */
    USART8_IRQn = 76,          /* USART8 global Interrupt                              */
    DMA2_Channel1_IRQn = 77,   /* DMA2 Channel 1 global Interrupt                      */
    DMA2_Channel2_IRQn = 78,   /* DMA2 Channel 2 global Interrupt                      */
    DMA2_Channel3_IRQn = 79,   /* DMA2 Channel 3 global Interrupt                      */
    DMA2_Channel4_IRQn = 80,   /* DMA2 Channel 4 global Interrupt                      */
    DMA2_Channel5_IRQn = 81,   /* DMA2 Channel 5 global Interrupt                      */
...
typedef struct
{
    __IO uint32_t OPA_CFGR1;
    __IO uint32_t OPA_CTLR1;
    __IO uint32_t OPA_CTLR2;
    __IO uint32_t CMP_CTLR;
    __IO uint32_t CMP_FILT;
    __IO uint32_t OPA_KEY;
    __IO uint32_t CMP_KEY;    
    __IO uint32_t OPCM_SR;  
} OPA_TypeDef;
...
/* Tounch key Converter */
typedef struct
{
    __IO uint32_t CTLR;
    __IO uint32_t TRANS_CFG;
    __IO uint32_t CAP_CFG;
    __IO uint32_t DRV_CFG;
    __IO uint32_t CDCC;
    __IO uint32_t SR;
} TKEY_TypeDef;
...
typedef struct
{
  __IO uint16_t BASE_CFG;
  __IO uint16_t INT_EN;
  __IO uint16_t SHST_CR;
  __IO uint8_t LPM_CFG;
  __IO uint8_t DEV_ADDR;
  __IO uint16_t INT_FLAG;
  __IO uint16_t INT_ST;
  __IO uint32_t LINK_CR;
  __IO uint32_t LINK_ST;
  __IO uint16_t TXLPM_DAT;
  __IO uint16_t RXLPM_DAT;
  __IO uint32_t TX_LEN;
  __IO uint32_t RX_LEN;
  __IO uint32_t MAX_LEN;
  __IO uint32_t TX_DMA;
  __IO uint32_t RX_DMA;
  __IO uint8_t TX_CFG;
  __IO uint8_t RX_CFG;
...
#define USART6_BASE                             (PB1PERIPH_BASE + 0x1800)
#define USART7_BASE                             (PB1PERIPH_BASE + 0x1C00)
#define USART8_BASE                             (PB1PERIPH_BASE + 0x2000)
...
#define USART5_BASE                             (PB1PERIPH_BASE + 0x5000)
...
#define GPIOE_BASE                              (PB2PERIPH_BASE + 0x1800)
#define ADC1_BASE                               (PB2PERIPH_BASE + 0x2400)
#define TKEY_BASE                               (PB2PERIPH_BASE + 0x2458)
...
#define DMA2_BASE                               (HBPERIPH_BASE + 0x0400)
#define DMA2_Channel1_BASE                      (HBPERIPH_BASE + 0x0408)
#define DMA2_Channel2_BASE                      (HBPERIPH_BASE + 0x041C)
#define DMA2_Channel3_BASE                      (HBPERIPH_BASE + 0x0430)
#define DMA2_Channel4_BASE                      (HBPERIPH_BASE + 0x0444)
#define DMA2_Channel5_BASE                      (HBPERIPH_BASE + 0x0458)
#define DMA2_Channel6_BASE                      (HBPERIPH_BASE + 0x046C)
#define DMA2_Channel7_BASE                      (HBPERIPH_BASE + 0x0480)
#define DMA2_Channel8_BASE                      (HBPERIPH_BASE + 0x0494)

#define RCC_BASE                                (HBPERIPH_BASE + 0x1000)
#define FLASH_R_BASE                            (HBPERIPH_BASE + 0x2000)
#define CRC_BASE                                (HBPERIPH_BASE + 0x3000)

#define USBHS_BASE                              (HBPERIPH_BASE + 0x3400)
#define USBHSD_BASE                             (USBHS_BASE)
#define USBHSH_BASE                             (USBHS_BASE + 0x100)

#define EXTEN_BASE                              (HBPERIPH_BASE + 0x3800)

#define QSPI1_BASE                              (HBPERIPH_BASE + 0x4C00)

#define PIOC_BASE                               (HBPERIPH_BASE + 0x5C00)

#define OPA_BASE                                (HBPERIPH_BASE + 0x6000)
#define USBPD_BASE                              (HBPERIPH_BASE + 0x7000)
#define LVDS_BASE                               (HBPERIPH_BASE + 0x7C00)
...
#define TKEY1                                   ((TKEY_TypeDef *)TKEY_BASE)
...
#define ADC_AWDRST_EN                           ((uint32_t)0x40000000)
#define ADC_SWDIS                               ((uint32_t)0x80000000)
...
#define ADC_OPAREGU                             ((uint32_t)0x00000010)
#define ADC_OPAINJE                             ((uint32_t)0x00000020)
...
#define ADC_INJESEL                             ((uint32_t)0x01000000)
#define ADC_REGUSEL                             ((uint32_t)0x02000000)
...
#define OPA_CFGR1_BKIN_CFG                        ((uint32_t)0x00000018)
#define OPA_CFGR1_BKIN_CFG_0                      ((uint32_t)0x00000008)
#define OPA_CFGR1_BKIN_CFG_1                      ((uint32_t)0x00000010)

#define OPA_CFGR1_RST_EN1                         ((uint32_t)0x00000020)
#define OPA_CFGR1_IE_OUT1                         ((uint32_t)0x00000100)
#define OPA_CFGR1_IE_CNT1                         ((uint32_t)0x00000200)
#define OPA_CFGR1_NMI_EN1                         ((uint32_t)0x00000400)

#define OPA_CFGR1_STCFG1                          ((uint32_t)0x00FF0000)
#define OPA_CFGR1_SMPSEL1                         ((uint32_t)0x10000000)
#define OPA_CFGR1_POLLMD1                         ((uint32_t)0x20000000)
#define OPA_CFGR1_OPA_LOCK                        ((uint32_t)0x80000000)
...
#define OPA_CTLR1_PSEL1_0                         ((uint32_t)0x00000008)
#define OPA_CTLR1_PSEL1_1                         ((uint32_t)0x00000010)

#define OPA_CTLR1_NSEL1                           ((uint32_t)0x00000020)

#define OPA_CTLR1_PGA_SEL1                        ((uint32_t)0x00000300)
#define OPA_CTLR1_PGA_SEL1_0                      ((uint32_t)0x00000100)
#define OPA_CTLR1_PGA_SEL1_1                      ((uint32_t)0x00000200)

#define OPA_CTLR1_FB_EN1                          ((uint32_t)0x00000400)
#define OPA_CTLR1_PGADIF1                         ((uint32_t)0x00000800)
#define OPA_CTLR1_HS1                             ((uint32_t)0x00001000)

#define OPA_CTLR1_POLL_EN1                        ((uint32_t)0x00010000)

#define OPA_CTLR1_POLL1_NUM                       ((uint32_t)0x00060000)
#define OPA_CTLR1_POLL1_NUM_0                     ((uint32_t)0x00020000)
#define OPA_CTLR1_POLL1_NUM_1                     ((uint32_t)0x00040000)

#define OPA_CTLR1_POLL1_NUM1                      ((uint32_t)0x00000000)
#define OPA_CTLR1_POLL1_NUM2                      ((uint32_t)0x00020000)
#define OPA_CTLR1_POLL1_NUM3                      ((uint32_t)0x00040000)

#define OPA_CTLR1_POLL_SEL                        ((uint32_t)0x00380000)
#define OPA_CTLR1_POLL_SEL_0                      ((uint32_t)0x00080000)
#define OPA_CTLR1_POLL_SEL_1                      ((uint32_t)0x00100000)
#define OPA_CTLR1_POLL_SEL_2                      ((uint32_t)0x00200000)

#define OPA_CTLR1_POLL_SWSTRT                     ((uint32_t)0x00800000)
#define OPA_CTLR1_POLL_CH1                        ((uint32_t)0x03000000)
#define OPA_CTLR1_POLL_CH2                        ((uint32_t)0x0C000000)
#define OPA_CTLR1_POLL_CH3                        ((uint32_t)0x30000000)
...
#define  OPA_CTLR2_NSEL2                          ((uint16_t)0x0020)
#define  OPA_CTLR2_PGA_SEL2                       ((uint16_t)0x0300)
#define  OPA_CTLR2_FB_EN2                         ((uint16_t)0x0400)
#define  OPA_CTLR2_PGADIF2                        ((uint16_t)0x0800)
#define  OPA_CTLR2_HS2                            ((uint16_t)0x1000)

/*******************  Bit definition for CMP_CTLR register  ********************/
#define  CMP_CTLR_EN1                         ((uint16_t)0x0001)
#define  CMP_CTLR_MODE1                       ((uint16_t)0x0006)
#define  CMP_CTLR_MODE1_0                     ((uint16_t)0x0002)
#define  CMP_CTLR_MODE1_1                     ((uint16_t)0x0004)

#define  CMP_CTLR_NSEL1                       ((uint16_t)0x0018)
#define  CMP_CTLR_NSEL1_0                     ((uint16_t)0x0008)
#define  CMP_CTLR_NSEL1_1                     ((uint16_t)0x0010)

#define  CMP_CTLR_PSEL1                       ((uint16_t)0x0060)
#define  CMP_CTLR_PSEL1_0                     ((uint16_t)0x0020)
#define  CMP_CTLR_PSEL1_1                     ((uint16_t)0x0040)

#define  CMP_CTLR_HYEN1                       ((uint16_t)0x0080)

#define  CMP_CTLR_EN2                         ((uint16_t)0x0100)
#define  CMP_CTLR_MODE2                       ((uint16_t)0x0600)
#define  CMP_CTLR_MODE2_0                     ((uint16_t)0x0200)
#define  CMP_CTLR_MODE2_1                     ((uint16_t)0x0400)

#define  CMP_CTLR_NSEL2                       ((uint16_t)0x1800)
#define  CMP_CTLR_NSEL2_0                     ((uint16_t)0x0800)
#define  CMP_CTLR_NSEL2_1                     ((uint16_t)0x1000)

#define  CMP_CTLR_PSEL2                       ((uint16_t)0x6000)
#define  CMP_CTLR_PSEL2_0                     ((uint16_t)0x2000)
#define  CMP_CTLR_PSEL2_1                     ((uint16_t)0x4000)

#define  CMP_CTLR_HYEN2                       ((uint16_t)0x8000)

#define  CMP_CTLR_RST_EN1                     ((uint32_t)0x00010000)
#define  CMP_CTLR_RST_EN2                     ((uint32_t)0x00020000)
#define  CMP_CTLR_BKIN_SEL                    ((uint32_t)0x00040000)

#define  CMP_CTLR_LP1                         ((uint32_t)0x00100000)
#define  CMP_CTLR_LP2                         ((uint32_t)0x00200000)
#define  CMP_CTLR_WKUP_MD                     ((uint32_t)0x00C00000)
#define  CMP_CTLR_WKUP_MD_0                   ((uint32_t)0x00400000)
#define  CMP_CTLR_WKUP_MD_1                   ((uint32_t)0x00800000)

#define  CMP_CTLR_DACEN                       ((uint32_t)0x01000000)

#define  CMP_CTLR_DACDAT                      ((uint32_t)0x1E000000)
#define  CMP_CTLR_DACDAT_0                    ((uint32_t)0x02000000)
#define  CMP_CTLR_DACDAT_1                    ((uint32_t)0x04000000)
#define  CMP_CTLR_DACDAT_2                    ((uint32_t)0x08000000)
#define  CMP_CTLR_DACDAT_3                    ((uint32_t)0x10000000)

#define  CMP_CTLR_HYS1_H                      ((uint32_t)0x20000000)
#define  CMP_CTLR_HYS2_H                      ((uint32_t)0x40000000)

#define  CMP_CTLR_CMP_LOCK                    ((uint32_t)0x80000000)

/*******************  Bit definition for CMP_FILT register  ********************/
#define  CMP_FILT_EN1                         ((uint16_t)0x0001)
#define  CMP_FILT_FILT1                       ((uint16_t)0x003E)
#define  CMP_FILT_EN2                         ((uint16_t)0x0100)
#define  CMP_FILT_FILT2                       ((uint16_t)0x3E00)

/*******************  Bit definition for OPA_KEY register  ********************/
#define  OPA_OPA_KEY                          ((uint32_t)0xFFFFFFFF)

/*******************  Bit definition for CMP_KEY register  ********************/
#define  CMP_CMP_KEY                          ((uint32_t)0xFFFFFFFF)

/*******************  Bit definition for OPCM_SR register  ********************/
#define  OPCM_SR_IF_OUT_POLL_CH1              ((uint32_t)0x0001)
#define  OPCM_SR_IF_OUT_POLL_CH2              ((uint32_t)0x0002)
#define  OPCM_SR_IF_OUT_POLL_CH3              ((uint32_t)0x0004)
#define  OPCM_SR_IF_POLL_OPA1                 ((uint32_t)0x0010)
...
#define  FSMC_BCR1_MTYP_SRAM_ROM              ((uint32_t)0x00000000)
#define  FSMC_BCR1_MTYP_PRAM                  ((uint32_t)0x00000004)
#define  FSMC_BCR1_MTYP_NORFLASH              ((uint32_t)0x00000008)
...
#define  FSMC_BCR1_MWID_8bit                  ((uint32_t)0x00000000)
#define  FSMC_BCR1_MWID_16bit                 ((uint32_t)0x00000010)
...
#define  FSMC_BTR1_DATAST_4                   ((uint32_t)0x00001000)
#define  FSMC_BTR1_DATAST_5                   ((uint32_t)0x00002000)
#define  FSMC_BTR1_DATAST_6                   ((uint32_t)0x00004000)
#define  FSMC_BTR1_DATAST_7                   ((uint32_t)0x00008000)
...
#define  FSMC_BTR1_ACCMOD_ModeA               ((uint32_t)0x00000000)
#define  FSMC_BTR1_ACCMOD_ModeB               ((uint32_t)0x10000000)
#define  FSMC_BTR1_ACCMOD_ModeC               ((uint32_t)0x20000000)
#define  FSMC_BTR1_ACCMOD_ModeD               ((uint32_t)0x30000000)
...
#define  FSMC_PCR2_PWID_8Bit                  ((uint32_t)0x00000000)
#define  FSMC_PCR2_PWID_16Bit                 ((uint32_t)0x00000010)

#define  FSMC_PCR2_ECCEN                      ((uint32_t)0x00000040)

#define  FSMC_PCR2_TCLR                       ((uint32_t)0x00001F00)
...
#define  FSMC_PCR2_TAR                        ((uint32_t)0x0001F000)
...
#define  FSMC_SR2_FEMPT                       ((uint32_t)0x00000040)

/*******************  Bit definition for FSMC_PMEM2 register  ********************/
#define  FSMC_PMEM2_MEMSETx                   ((uint32_t)0x000000FF)
#define  FSMC_PMEM2_MEMSETx_0                 ((uint32_t)0x00000001)
#define  FSMC_PMEM2_MEMSETx_1                 ((uint32_t)0x00000002)
#define  FSMC_PMEM2_MEMSETx_2                 ((uint32_t)0x00000004)
#define  FSMC_PMEM2_MEMSETx_3                 ((uint32_t)0x00000008)
#define  FSMC_PMEM2_MEMSETx_4                 ((uint32_t)0x00000010)
#define  FSMC_PMEM2_MEMSETx_5                 ((uint32_t)0x00000020)
#define  FSMC_PMEM2_MEMSETx_6                 ((uint32_t)0x00000040)
#define  FSMC_PMEM2_MEMSETx_7                 ((uint32_t)0x00000080)

#define  FSMC_PMEM2_MEMWAITx                   ((uint32_t)0x0000FF00)
#define  FSMC_PMEM2_MEMWAITx_0                 ((uint32_t)0x00000100)
#define  FSMC_PMEM2_MEMWAITx_1                 ((uint32_t)0x00000200)
#define  FSMC_PMEM2_MEMWAITx_2                 ((uint32_t)0x00000400)
#define  FSMC_PMEM2_MEMWAITx_3                 ((uint32_t)0x00000800)
#define  FSMC_PMEM2_MEMWAITx_4                 ((uint32_t)0x00001000)
#define  FSMC_PMEM2_MEMWAITx_5                 ((uint32_t)0x00002000)
#define  FSMC_PMEM2_MEMWAITx_6                 ((uint32_t)0x00004000)
#define  FSMC_PMEM2_MEMWAITx_7                 ((uint32_t)0x00008000)

#define  FSMC_PMEM2_MEMHOLDx                   ((uint32_t)0x00FF0000)
#define  FSMC_PMEM2_MEMHOLDx_0                 ((uint32_t)0x00010000)
#define  FSMC_PMEM2_MEMHOLDx_1                 ((uint32_t)0x00020000)
#define  FSMC_PMEM2_MEMHOLDx_2                 ((uint32_t)0x00040000)
#define  FSMC_PMEM2_MEMHOLDx_3                 ((uint32_t)0x00080000)
#define  FSMC_PMEM2_MEMHOLDx_4                 ((uint32_t)0x00100000)
#define  FSMC_PMEM2_MEMHOLDx_5                 ((uint32_t)0x00200000)
#define  FSMC_PMEM2_MEMHOLDx_6                 ((uint32_t)0x00400000)
#define  FSMC_PMEM2_MEMHOLDx_7                 ((uint32_t)0x00800000)

#define  FSMC_PMEM2_MEMHIZx                    ((uint32_t)0xFF000000)
#define  FSMC_PMEM2_MEMHIZx_0                  ((uint32_t)0x01000000)
#define  FSMC_PMEM2_MEMHIZx_1                  ((uint32_t)0x02000000)
#define  FSMC_PMEM2_MEMHIZx_2                  ((uint32_t)0x04000000)
#define  FSMC_PMEM2_MEMHIZx_3                  ((uint32_t)0x08000000)
#define  FSMC_PMEM2_MEMHIZx_4                  ((uint32_t)0x10000000)
#define  FSMC_PMEM2_MEMHIZx_5                  ((uint32_t)0x20000000)
#define  FSMC_PMEM2_MEMHIZx_6                  ((uint32_t)0x40000000)
#define  FSMC_PMEM2_MEMHIZx_7                  ((uint32_t)0x80000000)

/*******************  Bit definition for FSMC_PATT2 register  ********************/
#define  FSMC_PATT2_ATTSETx                   ((uint32_t)0x000000FF)
#define  FSMC_PATT2_ATTSETx_0                 ((uint32_t)0x00000001)
#define  FSMC_PATT2_ATTSETx_1                 ((uint32_t)0x00000002)
#define  FSMC_PATT2_ATTSETx_2                 ((uint32_t)0x00000004)
#define  FSMC_PATT2_ATTSETx_3                 ((uint32_t)0x00000008)
#define  FSMC_PATT2_ATTSETx_4                 ((uint32_t)0x00000010)
#define  FSMC_PATT2_ATTSETx_5                 ((uint32_t)0x00000020)
#define  FSMC_PATT2_ATTSETx_6                 ((uint32_t)0x00000040)
#define  FSMC_PATT2_ATTSETx_7                 ((uint32_t)0x00000080)

#define  FSMC_PATT2_ATTWAITx                   ((uint32_t)0x0000FF00)
#define  FSMC_PATT2_ATTWAITx_0                 ((uint32_t)0x00000100)
#define  FSMC_PATT2_ATTWAITx_1                 ((uint32_t)0x00000200)
#define  FSMC_PATT2_ATTWAITx_2                 ((uint32_t)0x00000400)
#define  FSMC_PATT2_ATTWAITx_3                 ((uint32_t)0x00000800)
#define  FSMC_PATT2_ATTWAITx_4                 ((uint32_t)0x00001000)
#define  FSMC_PATT2_ATTWAITx_5                 ((uint32_t)0x00002000)
#define  FSMC_PATT2_ATTWAITx_6                 ((uint32_t)0x00004000)
#define  FSMC_PATT2_ATTWAITx_7                 ((uint32_t)0x00008000)

#define  FSMC_PATT2_ATTHOLDx                   ((uint32_t)0x00FF0000)
#define  FSMC_PATT2_ATTHOLDx_0                 ((uint32_t)0x00010000)
#define  FSMC_PATT2_ATTHOLDx_1                 ((uint32_t)0x00020000)
#define  FSMC_PATT2_ATTHOLDx_2                 ((uint32_t)0x00040000)
#define  FSMC_PATT2_ATTHOLDx_3                 ((uint32_t)0x00080000)
#define  FSMC_PATT2_ATTHOLDx_4                 ((uint32_t)0x00100000)
#define  FSMC_PATT2_ATTHOLDx_5                 ((uint32_t)0x00200000)
#define  FSMC_PATT2_ATTHOLDx_6                 ((uint32_t)0x00400000)
#define  FSMC_PATT2_ATTHOLDx_7                 ((uint32_t)0x00800000)

#define  FSMC_PATT2_ATTHIZx                    ((uint32_t)0xFF000000)
#define  FSMC_PATT2_ATTHIZx_0                  ((uint32_t)0x01000000)
#define  FSMC_PATT2_ATTHIZx_1                  ((uint32_t)0x02000000)
#define  FSMC_PATT2_ATTHIZx_2                  ((uint32_t)0x04000000)
#define  FSMC_PATT2_ATTHIZx_3                  ((uint32_t)0x08000000)
#define  FSMC_PATT2_ATTHIZx_4                  ((uint32_t)0x10000000)
#define  FSMC_PATT2_ATTHIZx_5                  ((uint32_t)0x20000000)
#define  FSMC_PATT2_ATTHIZx_6                  ((uint32_t)0x40000000)
#define  FSMC_PATT2_ATTHIZx_7                  ((uint32_t)0x80000000)

/*******************  Bit definition for FSMC_ECCR2 register  ********************/
#define  FSMC_ECCR2_ECC                        ((uint32_t)0xFFFFFFFF)
...
#define  FSMC_BWTR1_DATAST_4                   ((uint32_t)0x00001000)
#define  FSMC_BWTR1_DATAST_5                   ((uint32_t)0x00002000)
#define  FSMC_BWTR1_DATAST_6                   ((uint32_t)0x00004000)
#define  FSMC_BWTR1_DATAST_7                   ((uint32_t)0x00008000)

#define  FSMC_BWTR1_BUSTYRN                    ((uint32_t)0x000F0000)
#define  FSMC_BWTR1_BUSTYRN_0                  ((uint32_t)0x00010000)
#define  FSMC_BWTR1_BUSTYRN_1                  ((uint32_t)0x00020000)
#define  FSMC_BWTR1_BUSTYRN_2                  ((uint32_t)0x00040000)
#define  FSMC_BWTR1_BUSTYRN_3                  ((uint32_t)0x00080000)
...
#define  FSMC_BWTR1_ACCMOD_MODA                ((uint32_t)0x00000000)
#define  FSMC_BWTR1_ACCMOD_MODB                ((uint32_t)0x10000000)
#define  FSMC_BWTR1_ACCMOD_MODC                ((uint32_t)0x20000000)
#define  FSMC_BWTR1_ACCMOD_MODD                ((uint32_t)0x30000000)

/******************************************************************************/
/*                            TKEY registers                                */
/******************************************************************************/

/*******************  Bit definition for TKEY_CTLR register  ********************/
#define   TKEY_CTLR_TKEN                       ((uint16_t)0x0001)
#define   TKEY_CTLR_ITUNE                      ((uint16_t)0x0002)
#define   TKEY_CTLR_MODE                       ((uint16_t)0x0004)
#define   TKEY_CTLR_CHSEL                      ((uint16_t)0x0008)
#define   TKEY_CTLR_TKACT                      ((uint16_t)0x0100)
#define   TKEY_CTLR_SCANIE                     ((uint16_t)0x0400)
#define   TKEY_CTLR_SCANEN                     ((uint16_t)0x0800)

#define   TKEY_CTLR_SCANNUM                    ((uint16_t)0xF000)
#define   TKEY_CTLR_SCANNUM_0                  ((uint16_t)0x1000)
#define   TKEY_CTLR_SCANNUM_1                  ((uint16_t)0x2000)
#define   TKEY_CTLR_SCANNUM_2                  ((uint16_t)0x4000)
#define   TKEY_CTLR_SCANNUM_3                  ((uint16_t)0x8000)

/*******************  Bit definition for TKEY_TRANS_CFG register  ********************/
#define   TKEY_TRANS_CFG_TRANSCC               ((uint16_t)0x0007)
#define   TKEY_TRANS_CFG_TRANSCC_0             ((uint16_t)0x0001)
#define   TKEY_TRANS_CFG_TRANSCC_1             ((uint16_t)0x0002)
#define   TKEY_TRANS_CFG_TRANSCC_2             ((uint16_t)0x0004)

#define   TKEY_TRANS_CFG_TRANSN                ((uint16_t)0x1FF8)
#define   TKEY_TRANS_CFG_TKSW                  ((uint16_t)0x6000)
#define   TKEY_TRANS_CFG_TKSW_0                ((uint16_t)0x2000)
#define   TKEY_TRANS_CFG_TKSW_1                ((uint16_t)0x4000)

#define   TKEY_TRANS_CFG_TKSW_1Tclk            ((uint16_t)0x0000)
#define   TKEY_TRANS_CFG_TKSW_2Tclk            ((uint16_t)0x2000)
#define   TKEY_TRANS_CFG_TKSW_4Tclk            ((uint16_t)0x4000)
#define   TKEY_TRANS_CFG_TKSW_8Tclk            ((uint16_t)0x6000)

/*******************  Bit definition for TKEY_CAP_CFG register  ********************/
#define   TKEY_CAP_CFG_SELCX                   ((uint32_t)0x0000000F)
#define   TKEY_CAP_CFG_SELCX_0                 ((uint32_t)0x00000001)
#define   TKEY_CAP_CFG_SELCX_1                 ((uint32_t)0x00000002)
#define   TKEY_CAP_CFG_SELCX_2                 ((uint32_t)0x00000004)
#define   TKEY_CAP_CFG_SELCX_3                 ((uint32_t)0x00000008)

#define   TKEY_CAP_CFG_SELCS                   ((uint32_t)0x000FFFF0)
#define   TKEY_CAP_CFG_SELCS_0                 ((uint32_t)0x00000010)
#define   TKEY_CAP_CFG_SELCS_1                 ((uint32_t)0x00000020)
#define   TKEY_CAP_CFG_SELCS_2                 ((uint32_t)0x00000040)
#define   TKEY_CAP_CFG_SELCS_3                 ((uint32_t)0x00000080)
#define   TKEY_CAP_CFG_SELCS_4                 ((uint32_t)0x00000100)
#define   TKEY_CAP_CFG_SELCS_5                 ((uint32_t)0x00000200)
#define   TKEY_CAP_CFG_SELCS_6                 ((uint32_t)0x00000400)
#define   TKEY_CAP_CFG_SELCS_7                 ((uint32_t)0x00000800)
#define   TKEY_CAP_CFG_SELCS_8                 ((uint32_t)0x00001000)
#define   TKEY_CAP_CFG_SELCS_9                 ((uint32_t)0x00002000)
#define   TKEY_CAP_CFG_SELCS_10                ((uint32_t)0x00004000)
#define   TKEY_CAP_CFG_SELCS_11                ((uint32_t)0x00008000)
#define   TKEY_CAP_CFG_SELCS_12                ((uint32_t)0x00010000)
#define   TKEY_CAP_CFG_SELCS_13                ((uint32_t)0x00020000)
#define   TKEY_CAP_CFG_SELCS_14                ((uint32_t)0x00040000)
#define   TKEY_CAP_CFG_SELCS_15                ((uint32_t)0x00080000)

/*******************  Bit definition for TKEY_DRV_CFG register  ********************/
#define   TKEY_DRV_CFG_DRVEN                   ((uint32_t)0x00000001)

#define   TKEY_DRV_CFG_DRVOUTSEL               ((uint32_t)0xFFFF0000)
#define   TKEY_DRV_CFG_DRVOUTSEL_0             ((uint32_t)0x00010000)
#define   TKEY_DRV_CFG_DRVOUTSEL_1             ((uint32_t)0x00020000)
#define   TKEY_DRV_CFG_DRVOUTSEL_2             ((uint32_t)0x00040000)
#define   TKEY_DRV_CFG_DRVOUTSEL_3             ((uint32_t)0x00080000)
#define   TKEY_DRV_CFG_DRVOUTSEL_4             ((uint32_t)0x00100000)
#define   TKEY_DRV_CFG_DRVOUTSEL_5             ((uint32_t)0x00200000)
#define   TKEY_DRV_CFG_DRVOUTSEL_6             ((uint32_t)0x00400000)
#define   TKEY_DRV_CFG_DRVOUTSEL_7             ((uint32_t)0x00800000)
#define   TKEY_DRV_CFG_DRVOUTSEL_8             ((uint32_t)0x01000000)
#define   TKEY_DRV_CFG_DRVOUTSEL_9             ((uint32_t)0x02000000)
#define   TKEY_DRV_CFG_DRVOUTSEL_10            ((uint32_t)0x04000000)
#define   TKEY_DRV_CFG_DRVOUTSEL_11            ((uint32_t)0x08000000)
#define   TKEY_DRV_CFG_DRVOUTSEL_12            ((uint32_t)0x10000000)
#define   TKEY_DRV_CFG_DRVOUTSEL_13            ((uint32_t)0x20000000)
#define   TKEY_DRV_CFG_DRVOUTSEL_14            ((uint32_t)0x40000000)
#define   TKEY_DRV_CFG_DRVOUTSEL_15            ((uint32_t)0x80000000)

/*******************  Bit definition for TKEY_CDCC register  ********************/
#define   TKEY_CDCC_TKCD                       ((uint32_t)0x000007FF)
#define   TKEY_CDCC_TKCC                       ((uint32_t)0x07FF0000)

/*******************  Bit definition for TKEY_SR register  ********************/
#define   TKEY_SR_SCANIF                       ((uint16_t)0x0001)

/*******************  Bit definition for TKEY_RSQR1 register  ********************/
#define   TKEY_RSQR1_SQ13                      ((uint32_t)0x0000001F)
#define   TKEY_RSQR1_SQ14                      ((uint32_t)0x000003E0)
#define   TKEY_RSQR1_SQ15                      ((uint32_t)0x00007C00)
#define   TKEY_RSQR1_SQ16                      ((uint32_t)0x000F8000)

/*******************  Bit definition for TKEY_RSQR2 register  ********************/
#define   TKEY_RSQR1_SQ7                       ((uint32_t)0x0000001F)
#define   TKEY_RSQR1_SQ8                       ((uint32_t)0x000003E0)
#define   TKEY_RSQR1_SQ9                       ((uint32_t)0x00007C00)
#define   TKEY_RSQR1_SQ10                      ((uint32_t)0x000F8000)
#define   TKEY_RSQR1_SQ11                      ((uint32_t)0x01F00000)
#define   TKEY_RSQR1_SQ12                      ((uint32_t)0x3E000000)

/*******************  Bit definition for TKEY_RSQR3 register  ********************/
#define   TKEY_RSQR1_SQ2                       ((uint32_t)0x000003E0)
#define   TKEY_RSQR1_SQ3                       ((uint32_t)0x00007C00)
#define   TKEY_RSQR1_SQ4                       ((uint32_t)0x000F8000)
#define   TKEY_RSQR1_SQ5                       ((uint32_t)0x01F00000)
#define   TKEY_RSQR1_SQ6                       ((uint32_t)0x3E000000)
...
#define CAN_RXMDH0R_RES                         ((uint32_t)0x00000040)
#define CAN_RXMDH0R_FMI                         ((uint32_t)0x0000FF00)
...
#define CAN_FCTLR_FINIT                         ((uint32_t)0x00000001)
...
#define  DMA_CFGR1_FLAG_CUR_MEM             ((uint32_t)0x10000)
...
#define  DMA_CFGR2_FLAG_CUR_MEM             ((uint32_t)0x10000)
...
#define  DMA_CFGR3_FLAG_CUR_MEM             ((uint32_t)0x10000)
...
#define  DMA_CFGR4_FLAG_CUR_MEM             ((uint32_t)0x10000)
...
#define  DMA_CFGR5_FLAG_CUR_MEM             ((uint32_t)0x10000)
...
#define  DMA_CFGR6_FLAG_CUR_MEM             ((uint32_t)0x10000)
...
#define  DMA_CFGR7_FLAG_CUR_MEM             ((uint32_t)0x10000)
...
#define  DMA_CFGR8_FLAG_CUR_MEM             ((uint32_t)0x10000)
...
#define FLASH_ACTLR_LATENCY                     ((uint8_t)0x0F) /* LATENCY[3:0] bits (Latency) */
...
#define FLASH_ACTLR_LATENCY_3                   ((uint8_t)0x03) 
#define FLASH_ACTLR_LATENCY_4                   ((uint8_t)0x04) 

#define FLASH_PEEN                              ((uint8_t)0x10) 
...
#define FLASH_CTLR_BER64                        ((uint32_t)0x00800000) /* Block Erase 64K */
...
#define AFIO_PCFR1_TIM1_CAP_RM                  ((uint32_t)0x80000000)
...
#define AFIO_CR_UDP_BC_VSRC                     ((uint32_t)0x00010000)
#define AFIO_CR_UDM_BC_VSRC                     ((uint32_t)0x00020000)
#define AFIO_CR_UDP_BC_CMPE                     ((uint32_t)0x00040000)
#define AFIO_CR_UDM_BC_CMPE                     ((uint32_t)0x00080000)
#define AFIO_CR_UDP_BC_CMPO                     ((uint32_t)0x00100000)
...
#define PWR_CTLR_R4KSTY                         ((uint32_t)0x00010000)
#define PWR_CTLR_R28KSTY                        ((uint32_t)0x00020000)
#define PWR_CTLR_R4KVBAT                        ((uint32_t)0x00040000)
#define PWR_CTLR_R28KVBAT                       ((uint32_t)0x00080000)
...
#define RCC_USBHS_PLLON                         ((uint32_t)0x00400000)
#define RCC_USBHS_PLLRDY                        ((uint32_t)0x00800000)
...
#define RCC_PLLMULL                             ((uint32_t)0x007C0000) /* PLLMUL[4:0] bits (PLL multiplication factor) */
...
#define RCC_PLLMULL_4                           ((uint32_t)0x00300000) /* Bit 4 */
...
#define RCC_PLLMULL17                           ((uint32_t)0x003C0000)
#define RCC_PLLMULL18                           ((uint32_t)0x00400000)
#define RCC_PLLMULL19                           ((uint32_t)0x00440000)
#define RCC_PLLMULL20                           ((uint32_t)0x00480000)
#define RCC_PLLMULL21                           ((uint32_t)0x004C0000)
#define RCC_PLLMULL22                           ((uint32_t)0x00500000)
#define RCC_PLLMULL23                           ((uint32_t)0x00540000)
#define RCC_PLLMULL24                           ((uint32_t)0x00580000)
#define RCC_PLLMULL25                           ((uint32_t)0x005C0000)
#define RCC_PLLMULL26                           ((uint32_t)0x00600000)
#define RCC_PLLMULL27                           ((uint32_t)0x00640000)
#define RCC_PLLMULL28                           ((uint32_t)0x00680000)
#define RCC_PLLMULL29                           ((uint32_t)0x006C0000)
#define RCC_PLLMULL30                           ((uint32_t)0x00700000)
#define RCC_PLLMULL31                           ((uint32_t)0x00740000)
#define RCC_PLLMULL32                           ((uint32_t)0x00780000)
#define RCC_PLLMULL33                           ((uint32_t)0x007C0000)
...
#define RCC_USBPRE                              ((uint32_t)0x70000000)
#define RCC_USBPRE_0                            ((uint32_t)0x10000000)
#define RCC_USBPRE_1                            ((uint32_t)0x20000000)
#define RCC_USBPRE_2                            ((uint32_t)0x40000000)

#define RCC_USBPRE_Div1                         ((uint32_t)0x00000000)
#define RCC_USBPRE_Div2                         ((uint32_t)0x10000000)
#define RCC_USBPRE_Div3                         ((uint32_t)0x20000000)
#define RCC_USBPRE_Div4                         ((uint32_t)0x30000000)
#define RCC_USBPRE_Div1_5                       ((uint32_t)0x40000000) /*USB clock from PLLCLK/1.5 */
#define RCC_USBPRE_Div2_5                       ((uint32_t)0x50000000) /*USB clock from PLLCLK/2.5 */
#define RCC_USBPRE_Div3_5                       ((uint32_t)0x60000000) /*USB clock from PLLCLK/3.5 */
...
#define RCC_USART6RST                           ((uint32_t)0x00000040)
#define RCC_USART7RST                           ((uint32_t)0x00000080)
#define RCC_USART8RST                           ((uint32_t)0x00000100)
...
#define RCC_USART5RST                           ((uint32_t)0x00100000)
...
#define RCC_DMA2EN                              ((uint16_t)0x0002) /* DMA2 clock enable */
#define RCC_SRAMEN                              ((uint16_t)0x0004) /* SRAM interface clock enable */
#define RCC_QSPI1                               ((uint16_t)0x0020)
#define RCC_CRCEN                               ((uint16_t)0x0040) /* CRC clock enable */
#define RCC_PIOCEN                              ((uint16_t)0x0080)
...
#define RCC_QSPI1RST                            ((uint32_t)0x00000020)
#define RCC_PIOCRST                             ((uint32_t)0x00000080)
#define RCC_FSMCRST                             ((uint32_t)0x00000100)
#define RCC_USBFSRST                            ((uint32_t)0x00001000)
#define RCC_USBPDRST                            ((uint32_t)0x00020000)

/*******************  Bit definition for RCC_CFGR2 register  ********************/
#define RCC_ADCSRC                              ((uint32_t)0x00600000)
#define RCC_ADCSRC_0                            ((uint32_t)0x00200000)
#define RCC_ADCSRC_1                            ((uint32_t)0x00400000)

#define RCC_ADCSRC_HCLKDIV                      ((uint32_t)0x00000000)
#define RCC_ADCSRC_HCLK                         ((uint32_t)0x00200000)
#define RCC_ADCSRC_USBHS_PLL_Div5               ((uint32_t)0x00400000)
#define RCC_ADCSRC_USBHS_PLL_Div6               ((uint32_t)0x00600000)

#define RCC_ADC_DUTY_SEL                        ((uint32_t)0x00800000)

#define RCC_USBHSPLLDIV                         ((uint32_t)0x07000000)
#define RCC_USBHSPLLDIV_0                       ((uint32_t)0x01000000)
#define RCC_USBHSPLLDIV_1                       ((uint32_t)0x02000000)
#define RCC_USBHSPLLDIV_2                       ((uint32_t)0x04000000)

#define RCC_USBHSPLLDIV_Div1                    ((uint32_t)0x00000000)
#define RCC_USBHSPLLDIV_Div2                    ((uint32_t)0x01000000)
#define RCC_USBHSPLLDIV_Div3                    ((uint32_t)0x02000000)
#define RCC_USBHSPLLDIV_Div4                    ((uint32_t)0x03000000)
#define RCC_USBHSPLLDIV_Div5                    ((uint32_t)0x04000000)
#define RCC_USBHSPLLDIV_Div6                    ((uint32_t)0x05000000)
#define RCC_USBHSPLLDIV_Div7                    ((uint32_t)0x06000000)
#define RCC_USBHSPLLDIV_Div8                    ((uint32_t)0x07000000)

#define RCC_USBHSPLLSRC                         ((uint32_t)0x08000000)

#define RCC_USBHSPLL_REFSEL                     ((uint32_t)0x30000000)
#define RCC_USBHSPLL_REFSEL_0                   ((uint32_t)0x10000000)
#define RCC_USBHSPLL_REFSEL_1                   ((uint32_t)0x20000000)
#define RCC_USBHSPLL_REFSEL_5M                  ((uint32_t)0x00000000)
#define RCC_USBHSPLL_REFSEL_8M                  ((uint32_t)0x10000000)
#define RCC_USBHSPLL_REFSEL_20M                 ((uint32_t)0x20000000)
#define RCC_USBHSPLL_REFSEL_24M                 ((uint32_t)0x30000000)
...
#define TIM_OE_MODE                             ((uint16_t)0x2000) /* only support Advanced Timer */
...
#define TIM4_ARR                                ((uint32_t)0xFFFFFFFF)
...
#define USART_CTLR1_OSMOD                       ((uint16_t)0x8000)
...
#define EXTEN_ULLDO_TRIM_0                      ((uint32_t)0x00000100) /* Bit 0 */
#define EXTEN_ULLDO_TRIM_1                      ((uint32_t)0x00000200) /* Bit 1 */
#define EXTEN_ULLDO_TRIM_2                      ((uint32_t)0x00000400) /* Bit 2 */

#define EXTEN_LDO_TRIM                          ((uint32_t)0x00003000) /* LDO_TRIM[1:0] bits */
#define EXTEN_LDO_TRIM_0                        ((uint32_t)0x00001000) /* Bit 0 */
#define EXTEN_LDO_TRIM_1                        ((uint32_t)0x00002000) /* Bit 1 */

#define EXTEN_LDO_TRIM0                         ((uint32_t)0x00000000) 
#define EXTEN_LDO_TRIM1                         ((uint32_t)0x00001000) 
#define EXTEN_LDO_TRIM2                         ((uint32_t)0x00002000) 
#define EXTEN_LDO_TRIM3                         ((uint32_t)0x00003000) 

/****************************  Enhanced register 1  *****************************/
#define EXTEN_DMA_ADC_RM                        ((uint16_t)0x0001) 
#define EXTEN_DMA_SPI1_RM                       ((uint16_t)0x0002) 
#define EXTEN_DMA_SPI2_RM                       ((uint16_t)0x0004) 
#define EXTEN_DMA_TIM1_UP_RM                    ((uint16_t)0x0008) 
#define EXTEN_DMA_TIM2_CH4_RM                   ((uint16_t)0x0010) 
#define EXTEN_DMA_TIM2_UP_RM                    ((uint16_t)0x0020) 
#define EXTEN_DMA_TIM3_CH1_RM                   ((uint16_t)0x0040) 
#define EXTEN_DMA_TIM3_CH3_RM                   ((uint16_t)0x0080) 
#define EXTEN_DMA_TIM3_CH4_RM                   ((uint16_t)0x0100) 
#define EXTEN_DMA_TIM4_CH1_RM                   ((uint16_t)0x0200) 
#define EXTEN_DMA_TIM4_CH3_RM                   ((uint16_t)0x0400) 
#define EXTEN_DMA_TIM4_UP_RM                    ((uint16_t)0x0800) 

#include "ch32v205_conf.h"
