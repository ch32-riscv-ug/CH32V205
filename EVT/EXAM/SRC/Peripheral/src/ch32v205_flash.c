...
#define CR_BER64                   ((uint32_t)0x00800000)
...
#define ValidAddrEnd               (FLASH_BASE + 0x40000)

/* FLASH Size */
#define Size_256B                  0x100
#define Size_2KB                   0x800
#define Size_64KB                  0x8000
 ...
 *            FLASH_Latency_3 - FLASH Latency mode 3
 *            FLASH_Latency_4 - FLASH Latency mode 4
 *
 * @return  none
 */
 ...
 *            FLASH_IT_WAKE_UP - FLASH wakeup Interrupt
 ...
 *            FLASH_FLAG_WRPRTERR - FLASH Write protected error flag
 *            FLASH_FLAG_EOP - FLASH End of Operation flag
 *            FLASH_FLAG_WAKE_UP - FLASH Wake up flag
 *
 * @return  none
 */
void FLASH_ClearFlag(uint32_t FLASH_FLAG)
{
    if(FLASH_FLAG == FLASH_FLAG_WAKE_UP)
    {
