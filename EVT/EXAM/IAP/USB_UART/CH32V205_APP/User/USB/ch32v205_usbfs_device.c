/********************************** (C) COPYRIGHT *******************************
 * File Name          : ch32v205_usbhs_device.c
 * Author             : WCH
 * Version            : V1.0.0
 * Date               : 2025/09/18
...
__attribute__((aligned(4))) uint8_t USBFS_EP2_Buf[2 * DEF_IAP_USB_PACK_SIZE];
        ...
        case USBFS_UIS_TOKEN_OUT:
            ...
            case USBFS_UIS_TOKEN_OUT | DEF_UEP2:
                if(intst & USBFS_UIS_TOG_OK)
                {
                    ...
                    USB_Pack_Out_Callback(DEF_USB_PORT_FS, USBFSD->RX_LEN & 0xFF);
        ...
        case USBFS_UIS_TOKEN_SETUP:
            ...
            else
            {
                ...
                case USB_GET_STATUS:
                    ...
                    {
                        if((uint8_t)(USBFS_SetupReqIndex & 0xFF) == (DEF_UEP_OUT | DEF_UEP2))
                        {
