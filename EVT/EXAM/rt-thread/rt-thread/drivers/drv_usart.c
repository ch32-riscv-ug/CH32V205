...
static struct ch32_uart_hw_config uart_hw_config[] =
{
#ifdef BSP_USING_UART1
    {
        /* clock configuration, please refer to ch32v20x_rcc.h */
        RCC_PB2Periph_USART1, RCC_PB2Periph_GPIOA,
    ...
    {
        /* clock configuration, please refer to ch32v20x_rcc.h */
        RCC_PB1Periph_USART2, RCC_PB2Periph_GPIOA,
        /* GPIO  configuration : TX_Port,TX_Pin, RX_Port,RX_Pin */
    ...
    {
        /* clock configuration, please refer to ch32v20x_rcc.h */
        RCC_PB1Periph_USART3, RCC_PB2Periph_GPIOA,
        /* GPIO  configuration : TX_Port,TX_Pin, RX_Port,RX_Pin */
        GPIOA, GPIO_Pin_13, /* Tx */GPIOA, GPIO_Pin_14, /* Rx */
        /* Whether to enable port remapping, you can refer to ch32v30x_gpio.h file,
        for example, USART1 needs to be turned on, you can use GPIO_Remap_USART1 */
        GPIO_Remap_NONE,
    },
    ...
    {
        /* clock configuration, please refer to ch32v20x_rcc.h */
        RCC_PB1Periph_USART4, RCC_PB2Periph_GPIOA,
        /* GPIO  configuration : TX_Port,TX_Pin, RX_Port,RX_Pin */
        GPIOA, GPIO_Pin_14, /* Tx */GPIOA, GPIO_Pin_15, /* Rx */
        /* Whether to enable port remapping, you can refer to ch32v30x_gpio.h file,
        for example, USART1 needs to be turned on, you can use GPIO_Remap_USART1 */
        GPIO_Remap_NONE,
    },
...
static rt_err_t ch32_configure(struct rt_serial_device *serial, struct serial_configure *cfg)
{
    ...
    RCC_PB2PeriphClockCmd(uart->hw_config->gpio_periph_clock, ENABLE);
    if(uart->config->Instance == USART1)
    {
        RCC_PB2PeriphClockCmd(uart->hw_config->uart_periph_clock, ENABLE);
    ...
    {
        RCC_PB1PeriphClockCmd(uart->hw_config->uart_periph_clock, ENABLE);
    }
