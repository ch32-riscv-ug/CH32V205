...
u8 NAND_Init(void)
{
    ...
    GPIO_Init(GPIOD, &GPIO_InitStructure);
    GPIO_PinAFConfig(GPIOD, GPIO_PinSource0, GPIO_AF7);
    GPIO_PinAFConfig(GPIOD, GPIO_PinSource1, GPIO_AF7);
    GPIO_PinAFConfig(GPIOD, GPIO_PinSource4, GPIO_AF7);
    GPIO_PinAFConfig(GPIOD, GPIO_PinSource5, GPIO_AF7);
    GPIO_PinAFConfig(GPIOD, GPIO_PinSource7, GPIO_AF7);
    GPIO_PinAFConfig(GPIOD, GPIO_PinSource11, GPIO_AF7);
    GPIO_PinAFConfig(GPIOD, GPIO_PinSource12, GPIO_AF7);
    GPIO_PinAFConfig(GPIOD, GPIO_PinSource14, GPIO_AF7);
    GPIO_PinAFConfig(GPIOD, GPIO_PinSource15, GPIO_AF7);
    ...
    GPIO_PinAFConfig(GPIOE, GPIO_PinSource7, GPIO_AF7);
    GPIO_PinAFConfig(GPIOE, GPIO_PinSource8, GPIO_AF7);
    GPIO_PinAFConfig(GPIOE, GPIO_PinSource9, GPIO_AF7);
    GPIO_PinAFConfig(GPIOE, GPIO_PinSource10, GPIO_AF7);
