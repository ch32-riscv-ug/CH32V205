...
/*
 *@Note
 *Timer DMA in sleep Mode routines:
 *TIM1_CH1(PA8)
 *This example demonstrates using DMA to output PWM through TIM1_CH1(PA8) pin in sleep Mode.
 *
 */
...
int main(void)
{
    ...
    TIM1_PWMOut_Init( 100-1, 16000-1, 50 );
